...
;;; This package releives (somewhat) the burden of writing and
...
;;; Nested constructs buit with lots of \(, |), \<, |>, \| seem to
...
;;; regexps, except for `srx-build-tree', which allowes only trailing
...
list of regexp-variants into a disicion-tree-like structure.
...
descrimination path. For instance,  (srx-build-tree \"cb[xy]\" \"cbx\")
...
Example:
 ...
 insert the following in orbitrary order \"adba\" \"abba\" \"adda\"  \"baba\"
  ==>
    ((a (b . \"ba\") (d (b . \"a\") (d . \"a\"))) (b . \"aba\"))
...
structured regexp that recognized eany of the elements of the
dictionary.
...
(defun srx-fixup-special-char (regexp special)
  "scan REGEXP and turn off special meaning of special"
  (let ((result "")
