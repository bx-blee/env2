;;; -*- Mode: Emacs-Lisp; -*-
;;; Rcs: $Id: bystar-emacsisit442.el,v 1.1 2016-02-10 02:28:34 lsipusr Exp $
...
(funcall  '(lambda () "
**      ====[[elisp:(org-cycle)][Fold]]====      *LanguageTool -- +diction/style*
"
...
(funcall  '(lambda () "
**      ====[[elisp:(org-cycle)][Fold]]====      *Bx Tool-Bar*
"
	     (require 'bx-tool-bar)
	     ))

;; (funcall  '(lambda () "
;; **      ====[[elisp:(org-cycle)][Fold]]====      *BAC highlight-indentation*
;; "
