...
;;(defvar festival-program-name "/usr/local/bin/festival")
(defvar festival-program-name "/usr/bin/festival")   ;;; It is standard on ubuntu. Should realy look for the program.
...
(defun festival-kd () 
  (interactive)
  (festival-send-command '(voice_kd_diphone)))
(defun festival-don () 
  (interactive)
...
(defun festival-german-de2-base () 
  (interactive)
  (festival-send-command '(voice_german_de2_linginto)))
(defun festival-german-de3-base () 
  (interactive)
  (festival-send-command '(voice_german_de3_linginto)))
(defun festival-german-de4-base () 
  (interactive)
  (festival-send-command '(voice_german_de4_linginto)))
(defun festival-german-de2-painte () 
  (interactive)
  (festival-send-command '(voice_german_de2_painte)))
(defun festival-german-de2-vqpainte8 () 
  (interactive)
  (festival-send-command '(voice_german_de2_vqpainte8)))
(defun festival-german-de3-vqpainte8 () 
  (interactive)
  (festival-send-command '(voice_german_de3_vqpainte8)))
(defun festival-german-de4-vqpainte8 () 
  (interactive)
  (festival-send-command '(voice_german_de4_vqpainte8)))
(defun festival-german-de2-vqpainte16 () 
  (interactive)
  (festival-send-command '(voice_german_de2_vqpainte16)))
(defun festival-german-de3-vqpainte16 () 
  (interactive)
  (festival-send-command '(voice_german_de3_vqpainte16)))
(defun festival-german-de4-vqpainte16 () 
  (interactive)
  (festival-send-command '(voice_german_de4_vqpainte16)))
...
(define-key say-lang-menu [say-lang-eng3] '("English don" . festival-don))
(define-key say-lang-menu [say-lang-eng2] '("English rab" . festival-rab))
(define-key say-lang-menu [say-lang-germ8] '("German basevoice de4 (male)" . festival-german-de4-base))
(define-key say-lang-menu [say-lang-germ7] '("German basevoice de3 (female)" . festival-german-de3-base))
(define-key say-lang-menu [say-lang-germ6] '("German basevoice de2 (male)" . festival-german-de2-base))
(define-key say-lang-menu [say-lang-germ5] '("German painte de2 (male)" . festival-german-de2-painte))
(define-key say-lang-menu [say-lang-germ9] '("German vqpainte16 de4 (male)" . festival-german-de4-vqpainte8))
(define-key say-lang-menu [say-lang-germ4] '("German vqpainte16 de3 (female)" . festival-german-de3-vqpainte8))
(define-key say-lang-menu [say-lang-germ3] '("German vqpainte16 de2 (male)" . festival-german-de2-vqpainte8))
(define-key say-lang-menu [say-lang-germ10] '("German vqpainte8 de4 (male)" . festival-german-de4-vqpainte8))
(define-key say-lang-menu [say-lang-germ2] '("German vqpainte8 de3 (female)" . festival-german-de3-vqpainte8))
(define-key say-lang-menu [say-lang-germ1] '("German vqpainte8 de2 (male)" . festival-german-de2-vqpainte8))
