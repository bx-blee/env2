...
;; Filename:      diction.el
;; Version:       $Id: diction.el,v 1.1 2015-01-27 18:22:03 lsipusr Exp $
...
(defvar diction-prefix-alist 
  '(((latex-mode tex-mode plain-tex-mode slitex-mode ams-tex-mode) . "detex | ")
    ((hm--html-mode html-mode html-helper-mode) . "dehtml -C | ")
    ((nroff-mode) . "deroff -C | ")
    ((text-mode) . "")
    )
...
;
; $Log: diction.el,v $
; Revision 1.1  2015-01-27 18:22:03  lsipusr
; *** empty log message ***
;
