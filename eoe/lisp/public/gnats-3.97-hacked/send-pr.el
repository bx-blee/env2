...
(defconst send-pr:datadir (or (gnats::get-config "DATADIR") "/opt/public/sde/lib")
...
(defvar send-pr:default-site
  (or (gnats::get-config "GNATS_SITE") "neda")
...
(defconst send-pr::fields
  (` (("Category" send-pr::set-categories
      ...
      ("Release" nil
       (, (or (gnats::get-config "DEFAULT_RELEASE") "unknown-1.0"))
       text)
      ("Submitter-Id" nil
