;;; 
;;; RCS: $Id: ndmt-www-lucid.el,v 1.1 2007-11-07 06:31:33 mohsen Exp $
;;;
...
(defun ndmt-www-show-ps-status ()
  (ndmt-run-command (format "/usr/bin/ps -ef | grep httpd-solaris | grep -v grep")
		    (ndmt-fqdn-host (ndmt-www-host))
		    (ndmt-user)
		    (ndmt-password)
		    ))
...
(defun ndmt-www-base-dir ()
  (format "/opt/public/networking/www/apache_1.1.1"))
